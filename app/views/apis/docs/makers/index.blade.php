	...
	<table class="table table-striped table-bordered table-hover docs-table">
	  ...
	  <tbody>
	    <tr>
		  ...
		  <td>One or more of the set of valid fields</td>
		  <td>
			...
			<div id="fields" class="collapse">
			  <ul class="list-group">
			    <li class="list-group-item"><span class="field">maker</span></li>
			    <li class="list-group-item"><span class="field">model</span></li>
			    <li class="list-group-item"><span class="field">price</span></li>
			    <li class="list-group-item"><span class="field">year</span></li>
			  </ul>
			</div>
		  </td>
		</tr>
